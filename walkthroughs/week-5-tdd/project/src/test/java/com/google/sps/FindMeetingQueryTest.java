...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredAndOptionalIsExcluded() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  @Test
  public void everyAttendeeIsConsideredAndOptionalIsIncluded() {
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  public void justEnoughRoomWithOptional() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", new TimeRange(TIME_0830AM, DURATION_15_MINUTES), Arrays.asList(PERSON_B)));
  ...
  public void onlyOptionalAttendees() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartEnd(TIME_0900AM, TIME_0930AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 3", TimeRange.fromStartDuration(TIME_0845AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)), 
  ...
  @Test
  public void noGapsOptionalAttendees() {
    //optional attendees have no gaps in their schedule
